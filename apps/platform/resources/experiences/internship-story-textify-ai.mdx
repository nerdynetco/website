...
Not boasting but I had a decent GitHub profile with some projects at that time. One of them was a real world project I built in 24 hours (initial version) alone check it out [here](https://app.nerdynet.co).
